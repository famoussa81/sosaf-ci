const COPY = {
  fr: {
    eyebrow: 'Catalogue Export', h1a: 'Fourniture continue de', h1b: 'fruits tropicaux', h1c: 'de qualité',
    ...
    cta1: 'Découvrir nos produits →', cta2: 'Nous contacter',
    presEyebrow: 'Qui sommes-nous', presTitle: "SOSAF-CI — L'excellence du fruit ivoirien",
    ...
    steps: [
      ...
      ['02', 'Devis sous 24h', 'Recevez une proposition détaillée avec prix et planning.'],
      ['03', 'Validation & préparation', 'Confirmation, paiement, sélection et conditionnement.'],
      ['04', 'Expédition', 'Maritime ou aérien, avec tous les documents export.'],
    ],
    faqEyebrow: 'Questions fréquentes', faqTitle: 'Tout savoir sur SOSAF-CI',
    faq: [
      ['Quels produits exportez-vous ?', 'Mangue (Kent, Amélie), noix de coco, avocat (Hass, Fuerte), banane (Cavendish) et ananas (MD2, Pain de Sucre, Cayenne Lisse).'],
      ['Quelles certifications qualité possédez-vous ?', 'Nos partenaires disposent de la certification GlobalG.A.P., notamment pour la mangue et la noix de coco.'],
      ['Quels volumes minimum de commande ?', 'Nous répondons aux commandes par conteneur complet ou par palette, selon vos besoins.'],
      ['Quels sont les délais et modes d\u2019expédition ?', 'Maritime (10–20 jours, conteneurs réfrigérés) ou aérien (2–5 jours) selon la destination et l\u2019urgence.'],
    ],
    ...
    formSent: '✓ Message envoyé — merci !', formSending: 'Envoi…',
    formError: "L'envoi a échoué. Réessayez ou écrivez-nous directement par email.",
  },
  en: {
    eyebrow: 'Export Catalog', h1a: 'A continuous supply of', h1b: 'tropical fruit', h1c: 'you can trust',
    ...
    cta1: 'Discover our products →', cta2: 'Contact us',
    presEyebrow: 'Who we are', presTitle: 'SOSAF-CI — Ivorian fruit at its best',
    ...
    steps: [
      ...
      ['02', 'Quote within 24h', 'Receive a detailed proposal with pricing and schedule.'],
      ['03', 'Confirmation & prep', 'Payment, selection and packing.'],
      ['04', 'Shipping', 'Sea or air freight, with all export documents.'],
    ],
    faqEyebrow: 'Frequently asked', faqTitle: 'Everything about SOSAF-CI',
    faq: [
      ['Which products do you export?', 'Mango (Kent, Amélie), coconut, avocado (Hass, Fuerte), banana (Cavendish) and pineapple (MD2, Sugarloaf, Smooth Cayenne).'],
      ['What quality certifications do you have?', 'Our partners hold GlobalG.A.P. certification, notably for mango and coconut.'],
      ['What is the minimum order volume?', 'We handle full-container orders as well as pallet-level orders, based on your needs.'],
      ['What are the shipping times and modes?', 'Sea freight (10–20 days, reefer containers) or air freight (2–5 days) depending on destination and urgency.'],
    ],
    ...
    formSent: '✓ Message sent — thank you!', formSending: 'Sending…',
...
const PRODUCT_COPY = {
  mango: {
    fr: [
      "La mangue est le produit phare du catalogue SOSAF-CI et la porte d'entrée de la plupart de nos relations commerciales. Nous nous approvisionnons auprès d'un réseau de producteurs, de coopératives et de stations de conditionnement partenaires en Côte d'Ivoire. Cette répartition nous permet de lisser les pics de récolte et de tenir un approvisionnement régulier sur toute la campagne, plutôt que sur quelques semaines.",
      "Deux variétés composent notre offre. La Kent, référence des circuits d'export longue distance, se reconnaît à sa chair peu fibreuse, à sa saveur douce et à sa bonne tenue au transport — des qualités qui la rendent particulièrement adaptée au fret maritime. L'Amélie, variété ouest-africaine, offre un parfum plus marqué et une texture plus fondante : elle s'adresse aux acheteurs qui cherchent un profil aromatique distinct du standard Kent.",
      "La campagne s'étend de mars à juillet. Les calibres disponibles vont de 6 à 12 fruits par colis selon la variété, ce qui permet d'ajuster chaque lot au format attendu par le marché de destination.",
      "Le conditionnement dépend du mode d'acheminement retenu. Pour le fret aérien, qui met 2 à 5 jours, les fruits sont conditionnés en cartons de 6 kg. Pour le maritime en conteneur réfrigéré, qui met 10 à 20 jours selon la destination, le format est le carton de 4 kg. Ce choix se décide avec vous au moment du devis, en fonction de votre délai et de votre budget transport.",
      "Nos coopératives et stations de conditionnement partenaires pour la mangue sont certifiées GlobalG.A.P. Chaque expédition fait l'objet d'un contrôle qualité avant départ, et la traçabilité est assurée du champ au conteneur. Les documents d'export sont fournis selon les exigences de la commande et du pays de destination.",
      "Nous traitons aussi bien les commandes par conteneur complet que par palette. Indiquez-nous la variété, le calibre, le volume et la destination souhaités : notre équipe revient vers vous sous 24 heures avec une proposition détaillée.",
    ],
    en: [
      "Mango is the flagship product in the SOSAF-CI catalogue and the entry point for most of our commercial relationships. We source from a network of partner growers, cooperatives and packing stations in Ivory Coast. That spread lets us smooth out harvest peaks and hold steady supply across the whole campaign rather than a few weeks.",
      "Two varieties make up our offer. Kent, the reference for long-distance export, is recognised by its low-fibre flesh, mild sweetness and resilience in transit — qualities that make it particularly well suited to sea freight. Amélie, a West African variety, has a stronger aroma and a softer texture: it suits buyers looking for an aromatic profile distinct from the Kent standard.",
      "The campaign runs from March to July. Sizes range from 6 to 12 fruits per box depending on the variety, so each lot can be matched to the format expected by its destination market.",
      "Packaging depends on the shipping mode chosen. For air freight, which takes 2 to 5 days, fruit is packed in 6 kg cartons. For sea freight in reefer containers, which takes 10 to 20 days depending on destination, the format is the 4 kg carton. That choice is settled with you at quotation stage, based on your lead time and freight budget.",
      "Our partner cooperatives and packing stations for mango are GlobalG.A.P.-certified. Every shipment is quality-checked before departure, and traceability is maintained from field to container. Export documents are provided according to the requirements of the order and the destination country.",
      "We handle full-container orders as well as pallet-level orders. Tell us the variety, size, volume and destination you need, and our team will come back within 24 hours with a detailed proposal.",
    ],
  },
  coconut: {
    fr: [
      "La noix de coco tient une place particulière dans notre catalogue : c'est, avec la mangue, le produit pour lequel nos partenaires sont certifiés GlobalG.A.P. Nous exportons la variété Grand Africa Ouest, produite en Côte d'Ivoire.",
      "Elle est proposée sous deux formes. La noix fraîche s'adresse aux circuits qui valorisent le fruit entier et acceptent un délai de transport court. La noix sèche, plus stable, supporte des acheminements plus longs et convient aux filières de transformation.",
      "Le conditionnement se fait en sacs de 21 kg. L'acheminement se fait par voie maritime en conteneur — comptez 10 à 20 jours selon la destination — ou par fret aérien en 2 à 5 jours lorsque le délai prime sur le coût.",
    ...
    en: [
      "Coconut holds a particular place in our catalogue: alongside mango, it is the product for which our partners are GlobalG.A.P.-certified. We export the Grand Africa West variety, grown in Ivory Coast.",
      "It comes in two forms. Fresh coconut suits channels that sell the whole fruit and can accept a short transit time. Dried coconut, being more stable, tolerates longer routes and suits processing industries.",
      "It is packed in 21 kg bags. Shipping is by sea container — allow 10 to 20 days depending on destination — or by air freight in 2 to 5 days when lead time matters more than cost.",
      ...
      "Full-container or pallet-level orders. Specify the form you need, fresh or dried, along with your volumes and destination, and you will receive a detailed quote within 24 hours.",
    ],
  },
  avocado: {
    fr: [
      "L'avocat est disponible toute l'année dans notre catalogue. Cette continuité est un argument en soi : elle permet de sécuriser un approvisionnement régulier plutôt que de dépendre d'une fenêtre saisonnière courte, et de construire un programme d'achat sur plusieurs mois.",
      "Deux variétés composent l'offre. La Hass, à peau granuleuse qui fonce à maturité, est la variété la plus demandée à l'international, appréciée pour sa chair onctueuse et sa maturation progressive. La Fuerte, à peau lisse et restant verte, offre une chair plus douce et un profil différent, pour les acheteurs qui souhaitent élargir leur gamme.",
      "Les calibres proposés vont de 16 à 22 fruits par colis. Le conditionnement suit le mode d'acheminement : carton de 6 kg pour l'aérien, en 2 à 5 jours, carton de 4 kg pour le maritime en conteneur réfrigéré, en 10 à 20 jours selon la destination.",
      "Chaque expédition fait l'objet d'un contrôle qualité avant départ, avec une traçabilité complète du champ au conteneur et les documents d'export correspondant à la commande.",
    ...
    en: [
      "Avocado is available all year in our catalogue. That continuity is an argument in itself: it lets you secure steady supply instead of depending on a short seasonal window, and build a purchasing programme across several months.",
      "Two varieties make up the offer. Hass, with its pebbled skin that darkens as it ripens, is the most requested variety internationally, valued for its creamy flesh and gradual ripening. Fuerte, with smooth skin that stays green, has milder flesh and a different profile, for buyers looking to broaden their range.",
      "Sizes range from 16 to 22 fruits per box. Packaging follows the shipping mode: a 6 kg carton for air freight, in 2 to 5 days, and a 4 kg carton for sea freight in reefer containers, in 10 to 20 days depending on destination.",
      "Every shipment is quality-checked before departure, with full traceability from field to container and the export documents matching the order.",
      "Full-container or pallet-level orders. Specify the variety, size, volumes and destination, and you will receive a detailed proposal within 24 hours.",
    ],
  },
  banana: {
    fr: [
      "SOSAF-CI exporte la banane de variété Cavendish, produite en Côte d'Ivoire. C'est la variété de référence du commerce international, retenue partout pour la régularité de son calibre, sa résistance à la manutention et sa tenue sur les circuits longs.",
      "Les volumes sont proposés selon disponibilité. Nous préférons confirmer la quantité réellement mobilisable au moment du devis plutôt que d'annoncer un tonnage théorique : cela évite les ruptures de programme en cours de campagne.",
      "Le conditionnement se fait en carton kraft de 18,5 kg, format standard des circuits export. L'expédition se fait par voie maritime en conteneur réfrigéré — comptez 10 à 20 jours selon la destination — ou par fret aérien en 2 à 5 jours lorsque le délai prime.",
      "Chaque expédition fait l'objet d'un contrôle qualité avant départ, avec une traçabilité complète du champ au conteneur. Les documents d'export sont fournis selon les exigences de la commande et du pays de destination.",
    ...
    en: [
      "SOSAF-CI exports Cavendish bananas grown in Ivory Coast. It is the reference variety in international trade, chosen everywhere for its consistent sizing, its resistance to handling and its resilience on long routes.",
      "Volumes are offered subject to availability. We prefer to confirm the quantity we can genuinely mobilise at quotation stage rather than announce a theoretical tonnage: it avoids programme breaks mid-campaign.",
      "Bananas are packed in 18.5 kg kraft cartons, the standard format for export channels. Shipping is by sea in reefer containers — allow 10 to 20 days depending on destination — or by air freight in 2 to 5 days when lead time is critical.",
      "Every shipment is quality-checked before departure, with full traceability from field to container. Export documents are provided according to the requirements of the order and the destination country.",
  ...
  pineapple: {
    fr: [
      "L'ananas est disponible toute l'année, ce qui en fait, avec l'avocat, l'un des deux produits de notre catalogue sur lesquels un programme d'achat continu peut être construit sans interruption saisonnière.",
      "Trois variétés composent l'offre. Le MD2 est le standard des marchés d'export, apprécié pour sa couleur franche, sa régularité de calibre et sa teneur en sucre. Le Pain de Sucre, plus fragile, se distingue par une chair très douce et peu acide. La Cayenne Lisse, variété historique de la filière ivoirienne, donne un fruit plus grand et plus acidulé. Ces trois profils couvrent des positionnements différents, du volume standard à l'offre de différenciation.",
      "Les calibres proposés vont de 6 à 12 fruits par colis, et le conditionnement se fait en cartons de 12 kg. L'acheminement se fait par voie maritime en conteneur réfrigéré, en 10 à 20 jours, ou par fret aérien en 2 à 5 jours selon la destination et l'urgence.",
      "Chaque expédition fait l'objet d'un contrôle qualité avant départ, avec une traçabilité complète du champ au conteneur et les documents d'export correspondant à la commande.",
    ...
    en: [
      "Pineapple is available all year, which makes it, alongside avocado, one of the two products in our catalogue on which a continuous purchasing programme can be built with no seasonal break.",
      "Three varieties make up the offer. MD2 is the export-market standard, valued for its clear colour, consistent sizing and sugar content. Sugar Loaf, more fragile, stands out for its very sweet, low-acid flesh. Smooth Cayenne, the historic variety of the Ivorian industry, gives a larger, more tart fruit. These three profiles cover different positionings, from standard volume to a differentiated offer.",
      "Sizes range from 6 to 12 fruits per box, and packaging is in 12 kg cartons. Shipping is by sea in reefer containers, in 10 to 20 days, or by air freight in 2 to 5 days depending on destination and urgency.",
      "Every shipment is quality-checked before departure, with full traceability from field to container and the export documents matching the order.",
...
function getSb() {
  ...
  window.__sb = window.supabase.createClient(window.SUPABASE_URL, window.SUPABASE_ANON_KEY, { auth: { persistSession: false } });
  return window.__sb;
}
...
async function fetchLiveProducts(lang) {
  ...
  if (!sb) return null;
  try {
    const [{ data: products, error: pErr }, { data: chars, error: cErr }, { data: photos, error: phErr }] = await Promise.all([
      sb.from('products').select('*').eq('visible', true).order('sort_order'),
      sb.from('product_chars').select('*').order('sort_order'),
      sb.from('product_photos').select('*').order('sort_order'),
    ]);
...
function trackVisit() {
  ...
  sb.from('visits').insert({ page: window.location.pathname || '/', ip: '' }).then(function (res) {
